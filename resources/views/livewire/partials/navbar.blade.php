  ...
  <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
    <div class="relative md:flex md:items-center md:justify-between">
      <div class="flex items-center justify-between">
        <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/" aria-label="Brand">Gyandipu</a>
        <div class="md:hidden">
          ...
          <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
            ...
            <div class="hs-dropdown relative">
              ...
              <button type="button"
                ...
                data-hs-dropdown-toggle="userDropdown"
              ...
              <!-- Dropdown Menu -->
              <div id="userDropdown"
                class="hs-dropdown-menu hidden opacity-0 transition-opacity absolute right-0 z-10 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700">
                
                <a class="block px-4 py-2 text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700" href="#">
                  My Orders
                </a>
                <a class="block px-4 py-2 text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700" href="#">
                  My Account
            ...
            <a class="block px-4 py-2 text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700" href="/logout">
              Logout
            </a>
            @endauth
